...
if(i==1)
{
  write.csv(submission,"SubAdder_2.csv",row.names = F)
}
else{
readsub<-read.csv("SubAdder_2.csv")
readsub<-data.frame(readsub,TARGET=submission$TARGET)
write.csv(readsub,"SubAdder_2.csv",row.names = F)
}
}
